...
\begin{proof}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      ...
      \fill[cyan, opacity=0.17] (-2,1) -- (-2, 3) -- (2, 3) -- (2, 1) -- cycle;
...
\begin{proof}
  ...
  \begin{flushright}
    \begin{minipage}{0.5\textwidth}
      \begin{tikzpicture}
        % Draw axes
        \draw[<->] (-2,0) -- (2,0) node[below right] {$\operatorname{Re}(z)$};
        \draw[<->] (0,-2) -- (0,2) node[above left] {$\operatorname{Im}(z)$};
        \fill[cyan,opacity=0.3] (-2,-1.5) -- (-2, -2) -- (2,-2) -- (2, 0) -- cycle;
        \draw[dashed] (-2, -1.5) -- (2, 0);
        % Draw line
        \draw[-,rotate=-68] (0,0) -- (0.7,0);
        \node at (0.35, -0.35) {A};
        \node at (0.7, -1.4) {$\Pi_\alpha$};
        \draw[-] (0, 0) -- (0:0.2) arc (0:-68:0.2) node[midway, right] {$\alpha$};
      \end{tikzpicture}
    \end{minipage}
  \end{flushright}
