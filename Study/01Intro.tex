...
\\
  ...
  \begin{definition}[Symmetric partial sum of a Fourier series]
    ...
    Given a function $f \in \L^1(\T)$ with its fourier series, $\sum_{-\infty}^\infty \hatf(n)e^{2\pi in x}$, we define the $n^{th}$ symmetric parial sum of its fourier series as
    \begin{displaymath}
  ...
  \begin{definition}[Summability kernels]
  ...
  \begin{definition}[Fej\'er Kernels]
