...
\section{Definiton and basic properties}
  ...
  \begin{proof}
    ...
    Now by \autoref{prop:Lp_functions_are_continuous_in_LpR} as $t \to \infty$, $\frac{1}{2t} \to 0$ and therefore $\hatf(t) \to 0$. Hence proved. 
  \end{proof}
...
Since we will be working a lot with functions $f$ which are continuous everywhere in the real line, we explicityly state the next theorem.
\begin{theorem}
